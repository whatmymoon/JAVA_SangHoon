...
public class IO01 {
	...
	public static void main(String[] args) throws IOException{
		...
		// 해당 버퍼에서 바이트 스트림은 1Byte씩 데이터를 읽어오고,
		// 문자스트림의 경우 2Byte씩 데이터를 읽어옵니다.
		// 기본 입력은 1바이트 읽기실행
		System.out.print("입력 : ");
		System.in.read();
		...
		// 그리고 입력버퍼에 남아있는 엔터뒤에 입력의 끝은 표시하는 문자하나가 더 입력됩니다. 그문자가 input에 저장
